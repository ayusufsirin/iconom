...
CUE_RANGE_THRUST_GAIN="${PHASE6_CUE_RANGE_THRUST_GAIN:-0.078}"
CUE_RANGE_DAMPING_GAIN="${PHASE6_CUE_RANGE_DAMPING_GAIN:-0.042}"
CUE_RANGE_INTEGRAL_GAIN="${PHASE6_CUE_RANGE_INTEGRAL_GAIN:-0.028}"
CUE_RANGE_INTEGRAL_LIMIT="${PHASE6_CUE_RANGE_INTEGRAL_LIMIT:-140.0}"
...
ros2_exec "
  ...
  /workspaces/ros2_ws/install/bin/live_rival_state_adapter --ros-args -p use_sim_time:=true -p publish_rate_hz:=\"${RIVAL_PUBLISH_RATE_HZ}\"
