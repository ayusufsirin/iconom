...
PLANE2_ROUTE_POINT1_NORTH_M="${PHASE6_LIVE_RIVAL_RECT_POINT1_NORTH_M:-40.0}"
...
PLANE2_ROUTE_POINT2_EAST_M="${PHASE6_LIVE_RIVAL_RECT_POINT2_EAST_M:-40.0}"
PLANE2_ROUTE_POINT3_NORTH_M="${PHASE6_LIVE_RIVAL_RECT_POINT3_NORTH_M:--40.0}"
...
PLANE2_ROUTE_POINT4_EAST_M="${PHASE6_LIVE_RIVAL_RECT_POINT4_EAST_M:--40.0}"
...
echo "  - recorded ownship-versus-rival geometry shows a sustained airborne catch in the forward cone with meaningful range closure and final proximity"
